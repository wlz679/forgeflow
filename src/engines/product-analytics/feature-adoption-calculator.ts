...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I launch a feature for high adoption?", a: "Top tactics: 1) In-app announcement (5-10x lift vs email), 2) Onboarding flow integration, 3) Default-on (controversial but effective), 4) Email + push + in-app combo, 5) Sales/CSM enablement, 6) Tutorial overlay. Most teams: 5-15% adoption in first 30 days. Top performers: 30-50% in 30 days. Best: integrate into existing flow (not separate page)." },
    { q: "What is the difference between adoption and engagement?", a: "Adoption: % of users who try the feature (binary). Engagement: how often and deeply users use it. Examples: Slack: adopted = 50%, engaged = 30% (daily active in feature). Track: adoption (breadth) + engagement (depth). High adoption + low engagement = surface-level use. Low adoption + high engagement = power-user feature. Best: high in both." },
