...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is the impact of push notifications on stickiness?", a: "Push notifications: 1) Increase DAU by 10-30%, 2) Increase stickiness by 5-15%, 3) Risk: opt-outs. Opt-out rate: 5-20% per month without relevance. Best: 1-3 notifications/day, 2) Personalized timing, 3) Value-driven content, 4) Easy opt-out. Most teams: 20-50% stickiness lift with good push. Avoid: notification fatigue (too many = churn)." },
