...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I optimize checkout funnel?", a: "Top tactics: 1) Guest checkout (no forced signup), 2) Single-page vs multi-step (often single wins), 3) Progress indicator, 4) Auto-fill (address, payment), 5) Multiple payment options (Apple Pay, PayPal, Google Pay), 6) Show total cost upfront, 7) Free shipping over $X. Most teams: 20-40% checkout completion lift. Each tactic: 5-10% lift. Test 1-2 changes at a time." },
