...
return run(inputs, pick, fill);`,
  ...
  faq: [
    ...
    { q: "How do I maintain ad revenue with consent management?", a: "Tactics: 1) Better opt-in UX (clear value prop, \"I accept all\"), 2) First-party data (email, accounts), 3) Server-side conversion tracking, 4) Contextual ads (no user data needed), 5) CMP optimization (timing, design, copy), 6) Privacy-safe ad networks (Google Topics, FLEDGE). Most teams: 5-10% revenue loss vs. 30-50% without optimization." },
