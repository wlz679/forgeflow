...
return run(inputs, pick, fill);`,
  ...
  faq: [
    ...
    { q: "How much revenue do I lose with consent management?", a: "EU opt-in reduces tracking by 30-50%. Ad revenue impact: 5-15% of total. Personalization impact: 20-40% lower. Analytics impact: 30-50% of data. Mitigations: 1) First-party data strategy, 2) Contextual advertising, 3) Server-side tracking, 4) Better opt-in UX. Most companies: 5-10% revenue impact in regulated markets, 0% in others." },
    { q: "How do I maintain ad revenue with consent management?", a: "Tactics include 1) Better opt-in UX (clear value prop, \"I accept all\"), 2) First-party data (email, accounts), 3) Server-side conversion tracking, 4) Contextual ads (no user data needed), 5) CMP optimization (timing, design, copy), 6) Privacy-safe ad networks (Google Topics, FLEDGE). Most teams 5-10% revenue loss vs. 30-50% without optimization." },
    { q: "What is first-party data strategy?", a: "First-party data = data collected directly from user (email, behavior, preferences). Examples: newsletter signup, account creation, surveys, support interactions. Benefits: 1) Compliance-friendly, 2) Higher quality, 3) Lower cost than ads, 4) Better attribution. Tactics: gated content, preference centers, loyalty programs. Most companies: 30-50% of marketing data from first-party within 2 years." },
    { q: "How does server-side tracking help with consent?", a: "Server-side: tracking happens on your server, not browser. Benefits: 1) Bypasses browser cookie restrictions (ITP, Safari), 2) Better data accuracy, 3) Faster load times, 4) More control. Implementation: 1-2 weeks for Google Analytics, 1-2 months for full server-side. Cost: 2-5x of client-side. Most teams: 20-40% data recovery vs. client-only." },
    { q: "What is contextual advertising?", a: "Contextual ads: ads based on page content, not user data. Privacy-friendly by design. Examples: Google Display & Video 360 contextual, Taboola, Outbrain. CPMs: 30-50% lower than behavioral. Performance: 50-70% of behavioral for awareness, 30-50% for conversion. Most teams: 10-30% of total ad spend on contextual. Improves with first-party data." },
    { q: "How does consent affect email marketing?", a: "Email: requires explicit opt-in (GDPR, CAN-SPAM). Impact: list growth 30-50% slower without incentives. Mitigations: 1) Lead magnets, 2) Preference center, 3) Clear value prop, 4) Double opt-in (better quality). Email revenue: typically 2-3x ads. Compensate for slow list growth. Most teams: 30-50% list growth with opt-in vs. 100% without." },
    { q: "What is the role of preference centers?", a: "Preference center: lets users choose what they receive. Benefits: 1) Better consent (more granular), 2) Higher engagement (subscribers choose interests), 3) Lower unsubscribe (control = trust), 4) Compliance. Example: choose topics, frequency, channels. Conversion: 20-50% better than binary opt-in. Most teams: 2-4 week project, 30% engagement lift." },
    { q: "How long does it take to recover from consent revenue loss?", a: "Most teams 6-12 months to reach pre-consent revenue. Tactics include 1) First-party data (12-18 months), 2) Server-side tracking (1-2 months), 3) Better opt-in UX (immediate), 4) Contextual ads (1-3 months), 5) Email optimization (3-6 months). Plan: 30-50% loss first 3 months, 10-20% by month 12, 0% by month 18. Communicate with stakeholders." },
  ],
  howToUse: [
