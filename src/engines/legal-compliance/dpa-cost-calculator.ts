...
return run(inputs, pick, fill);`,
  ...
  faq: [
    ...
    { q: "How much does a DPA cost?", a: "Standard DPA from enterprise vendor: free (Salesforce, AWS, Google). Custom DPA: $5-50K in legal fees. Most companies: 10-50 vendor DPAs to negotiate. Total legal cost: $50-500K for full portfolio. Cheaper alternative: GDPR-compliant contract templates ($500-5K). Best: standardized template + light customization per vendor." },
