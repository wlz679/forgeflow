...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a customer health score?", a: "CHS = composite score (0-100) predicting churn risk. Inputs: 1) Product usage (logins, features), 2) Support tickets, 3) NPS/CSAT, 4) Tenure, 5) Engagement (emails, community). Low score: high churn risk. High score: healthy. Track weekly. Use: 1) Prioritize CSM outreach, 2) Predict renewals, 3) Identify upsell opportunities. Most: 70+ = healthy, <50 = at risk." },
    { q: "What are the components of a customer health score?", a: "Common: 1) Product usage (40%): logins, features used, depth, 2) Engagement (20%): emails opened, support tickets, community, 3) Relationship (20%): exec sponsor, CSM touchpoints, 4) Account (20%): tenure, plan, contract size. Weight varies by business. Most: 5-10 inputs. Score: weighted average. Update weekly. Re-evaluate quarterly." },
    { q: "How do I build a customer health score?", a: "Process: 1) List candidate signals (usage, support, NPS, etc.), 2) Score 0-100 each, 3) Weight (sum to 100%), 4) Calculate composite, 5) Validate against churn (correlation). Iterate. Most: 5-10 signals. Tools: Gainsight, ChurnZero, Vitally, custom. Start simple (3-5 signals), expand. Re-evaluate every 6 months. Validate with: 1) Actual churn correlation, 2) Renewal rates, 3) NPS." },
    { q: "What is a good CHS benchmark?", a: "Benchmarks: 1) 80-100: champion, 2) 60-79: healthy, 3) 40-59: at risk, 4) 0-39: critical. Most: 70+ is healthy base. <50: at risk. Distribution: 30% champions, 40% healthy, 20% at risk, 10% critical. Track: distribution over time. Healthy growth: shift to 60+. Avoid: gaming the score (manipulation). Calibrate quarterly." },
    { q: "How do I use CHS for churn prevention?", a: "Workflow: 1) Score 0-100 weekly, 2) Categorize (champion, healthy, at risk, critical), 3) Auto-alert CSM for at-risk, 4) Outreach (call, email, meeting), 5) Action plan, 6) Track. Most teams: 30-50% reduction in voluntary churn with proactive outreach. CSM time: focus on at-risk. Tier 1 (top 20%): 80% of CSM time. Bottom 20%: low-touch or save." },
    { q: "How often should CHS update?", a: "Updates: 1) Daily for product usage, 2) Weekly for engagement, 3) Monthly for relationship/account, 4) Quarterly for full recalibration. Most: weekly composite. Critical signals (usage drop): real-time alerts. Avoid: real-time composite (too noisy). Tools: Gainsight (real-time), ChurnZero (daily), custom (depends). Most: weekly is enough. Daily alerts for usage drops >50%." },
    { q: "What is the difference between CHS and NPS?", a: "NPS: surveys users (would you recommend?). CHS: composite of behavior + relationship. NPS is leading (predicts churn 3-6 months out). CHS is leading AND current (predicts + identifies). Track both. NPS: survey data. CHS: real-time data. NPS: quarterly. CHS: weekly. Best: NPS for trend, CHS for action. Most: CHS is more actionable, NPS is more comparable across companies." },
    { q: "How do I avoid CHS gaming or manipulation?", a: "Anti-gaming: 1) Multiple signals, 2) Hard to fake signals (real usage), 3) No \"make it green\" override, 4) Quarterly recalibration, 5) Validate against actual churn. Avoid: weights that are too easy to manipulate. Real signals: product usage, ticket volume, NPS, support satisfaction. Less reliable: sentiment analysis, social media. Best: 5-10 signals, mix of objective + subjective, validated." },
  ],
  howToUse: [
