...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is expansion revenue?", a: "Expansion revenue = revenue gained from existing customers (upsell, cross-sell, more seats, more usage). Components: 1) Seat expansion (more users), 2) Tier upgrade (Pro to Enterprise), 3) Usage expansion (more API calls, more storage), 4) Cross-sell (related products). Net Revenue Retention (NRR) measures it. Best-in-class SaaS: 120%+ NRR. Most: 100-110% NRR. Track: monthly, by cohort." },
    ...
    { q: "What are the top expansion revenue strategies?", a: "Top 5: 1) Usage-based pricing (more usage = more revenue), 2) Tier upgrades (free → pro → enterprise), 3) Seat expansion (more users per account), 4) Add-ons (premium features, services), 5) Cross-sell (related products). SaaS best practice: 1) usage + 2) tier + 3) seats. Most teams: 5-15% of revenue from expansion. Top: 20-30% of revenue from expansion." },
