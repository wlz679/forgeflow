...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is logo churn rate?", a: "Logo churn = % of customers lost per period. Excludes revenue (just counts customers). Benchmarks: 1) Annual logo churn: <10% is excellent, 10-20% is healthy, 20-30% is concerning, >30% is critical. Monthly: 0.5-1% is good, 1-2% is average. By segment: SMB 3-5%/month, mid-market 1-2%, enterprise 0.5-1%. Most B2B SaaS: 1-2% monthly." },
    ...
    { q: "How do I reduce logo churn?", a: "Top tactics: 1) Better onboarding (cut time-to-value), 2) Customer success for top accounts, 3) Quarterly business reviews, 4) Health scoring, 5) Reduce support friction, 6) Better qualification. Most teams: 1-2 pp reduction per year. Aim: 5 pp in 12 months. Top tactics: 1) Onboarding + 2) Health scoring. CSM impact: 1 FTE per $1-2M ARR. Most: 30-50% churn reduction with strong CS." },
    ...
    { q: "How is logo churn measured?", a: "Logo churn = customers_lost / customers_at_start × 100. Track: monthly, by cohort, by plan, by source. Voluntary + involuntary. Exclude: customers who upgraded (sometimes called \"negative churn\"). Tools: CRM (Salesforce), billing (Stripe), product (Mixpanel). Most: track monthly and trailing 3-6 month average. Cohort view: more meaningful. Track: cumulative churn by tenure." },
    { q: "What is the leading indicator of logo churn?", a: "Top indicators: 1) Drop in product usage (40%+ drop in 30 days), 2) Drop in support engagement, 3) Negative NPS, 4) Key contact left company, 5) No usage in 30 days, 6) Support escalations, 7) No renewal meeting. Use: 1) Health scoring, 2) Automated alerts, 3) CSM outreach. Most: predict 30-60 days in advance. Best: 90 days. Action: before renewal, not after." },
