...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good GRR for SaaS?", a: "Benchmarks: 1) <80%: critical (revenue declining), 2) 80-90%: average, 3) 90-95%: good, 4) 95%+: best-in-class. By company size: SMB SaaS 80-90%, mid-market 90-95%, enterprise 95%+. Most teams: 90%+ is good. Top quartile: 95%+. Track: monthly cohort. GRR is the cleanest measure of customer health. If GRR <80%, fix retention before scaling." },
    { q: "How do I improve GRR?", a: "Top tactics: 1) Better onboarding (reduce time-to-value), 2) Proactive customer success, 3) Reduce support friction, 4) Product stickiness (more features used), 5) Better qualification (avoid bad-fit customers), 6) Loyalty programs. Most teams: 2-5 pp improvement per year. Aim: 5-10 pp in 12 months. Tactics: invest in CS team (1 FTE per $1-2M ARR). Best: product-led growth reduces churn." },
