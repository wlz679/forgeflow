...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I improve renewal rates?", a: "1) Proactive customer success (1:1 QBRs), 2) Value realization (track outcomes), 3) Renewal process (90 days out), 4) Executive alignment, 5) Adoption programs, 6) Risk scoring. Most teams 5-15 pp improvement. Aim for 90%+ gross. CSM impact: 1 FTE per $1-2M ARR. Best option: align CSM comp to renewals (not just satisfaction). 95%+ gross." },
    ...
    { q: "What are the top reasons for non-renewal?", a: "1) Not seeing value (40-50%), 2) Budget (15-20%), 3) Switching to competitor (15-20%), 4) Company downsized/changed (10-15%), 5) Bad support (5-10%). Address: 1) Value realization, 2) ROI documentation, 3) Competitive intel, 4) Account changes, 5) CSAT. 50%+ of non-renewal is preventable. Track exit interview data. Improve weakest area first." },
    { q: "Should I discount for renewal?", a: "Tactic-dependent. Avoid 1) Discounting without value conversation (signals weakness), 2) Same discount every year (entitlement), 3) Large discounts (>20%). Use 1) Multi-year lock (10-15% off), 2) Price increase with notice, 3) Bundled services, 4) Renewal for term extension. Best option: never discount on renewal alone. Increase value. 5-10% of renewals get small discounts. 1-3%." },
