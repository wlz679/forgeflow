...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good CAC payback period?", a: "Benchmarks: 1) <6 months: world-class, 2) 6-12 months: healthy, 3) 12-18 months: acceptable, 4) 18-24 months: concerning, 5) >24 months: critical. Most SaaS: 12-18 months. By segment: SMB 6-12, mid-market 12-18, enterprise 18-24. Most: target 12-month payback. For $1K CAC, $100/mo ARPU, 80% margin: 12.5-month payback. Aim: <12. Top: <6." },
    ...
    { q: "How do I reduce CAC?", a: "Top tactics: 1) Better targeting (right audience), 2) Better creative (test 3-5 versions), 3) Better landing pages, 4) SEO (organic, lower CAC over time), 5) Referral programs (5-10x LTV), 6) Partnerships, 7) PLG (product-led growth). Most: 20-50% CAC reduction in 12 months. Top tactic: SEO + referrals. Most teams: 2-3x ROI on content. Be patient: organic takes 6-12 months." },
    { q: "What is the difference between blended and paid CAC?", a: "Blended CAC: total S&M / total customers. Includes organic, paid, referral. Paid CAC: paid S&M / paid customers. Blended: lower (organic drags down). Paid: higher (just paid). Track: both. For benchmarking: paid CAC (cleaner). For unit economics: blended (all revenue). Most: paid 2-3x blended. Aim: 1.5-2x. Most teams: organic 30-50% of customers. Track: by channel, monthly." },
    { q: "How does CAC relate to LTV?", a: "LTV:CAC = key unit economics. Benchmarks: 1) 1:1 = break-even, 2) 3:1 = healthy, 3) 5:1 = under-investing, 4) 10:1 = excellent. For LTV $3K, CAC $1K: 3:1. For LTV $5K, CAC $1K: 5:1. Most: target 3:1+. Investors: minimum 3:1 for investable. Calculate: (LTV × gross_margin) / CAC. Aim: improving LTV:CAC over time. Most teams: 3-4x target. Top: 5x+." },
    ...
    { q: "How do I benchmark CAC by industry?", a: "Benchmarks: 1) B2B SaaS SMB: $300-1500, 2) B2B SaaS mid-market: $1-5K, 3) Enterprise SaaS: $5-50K, 4) E-commerce: $50-200, 5) Mobile apps: $1-10, 6) Fintech: $100-500, 7) Healthcare: $500-3000. By vertical: 1) Martech: $500-2K, 2) HR: $1-3K, 3) Sales: $1-3K, 4) Engineering: $1-5K. Most: industry-specific. Use: SaaS Capital, OpenView, KeyBanc. Track: by segment." },
  ],
  howToUse: [
