...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is the Rule of 40?", a: "Rule of 40: revenue growth rate + profit margin should be ≥40%. For 50% growth + (-10%) margin: 40% (pass). For 30% growth + 15% margin: 45% (pass). For 100% growth + (-50%) margin: 50% (pass). Investors: gold standard. Above 40: premium multiple. Below: discount. Most: aim for 50-80. Top: 80%+. Track: TTM (trailing 12 months) or forward. Be honest: it's a balance, not a single metric." },
    { q: "What is Burn Multiple?", a: "Burn multiple = net burn / net new ARR. Measures: capital efficiency. For $5M net burn, $10M net new ARR: 0.5x. Lower = more efficient. Benchmarks: 1) <0.5x: world-class, 2) 0.5-1x: excellent, 3) 1-2x: good, 4) 2-3x: concerning, 5) >3x: inefficient. Top: <1x. Most: aim for <2x. Investors: prefer <1x. Track: trailing 12 months. Combine with Rule of 40 for full picture." },
    { q: "How do I improve my Rule of 40 score?", a: "Top tactics: 1) Increase growth (more revenue, faster), 2) Increase margin (cut costs), 3) Both. Most: 1) Growth is harder. 2) Margin easier. Most teams: cut costs 10-20% = 5-10 pp margin lift. Growth: depends on product + market. Aim: 50%+ growth + 20%+ margin = 70 rule of 40. Or: 30% growth + 30% margin = 60. Top: 100% growth + 0% margin = 100 (great if capital efficient)." },
    { q: "What is a good Burn Multiple for seed stage?", a: "Seed: 1) Pre-PMF: 2-5x (high burn, low ARR), 2) PMF: 1-2x, 3) Growth: 0.5-1x, 4) Series A ready: <1x. Most: aim for 1x by Series A. Top: <0.5x. Avoid: >3x (capital inefficient). Track: monthly. Most: validate efficiency before raising. Investors: key metric. Capital efficiency: separates good from great. Most: improve 1-2x per year. Aim: <1x by $1-2M ARR." },
    { q: "What is the relationship between Rule of 40 and valuation?", a: "Higher Rule of 40 = higher multiple. Below 40: 3-6x ARR. Above 40: 8-12x. 50-60: 12-18x. 80+: 18-30x. Investors: Rule of 40 is the gate. Above 40: investable. Below: risky. Most: 40-60 is the target. Top: 80+. Use: TTM (trailing 12 months). Most: track quarterly. Show: improving trend matters. Most teams: 5-10 pp improvement per year." },
    { q: "Can I have a high Rule of 40 with negative margin?", a: "Yes, if growth is high enough. 100% growth + (-50%) margin = 50 (above 40). Investors: accept this for early stage. Trade-off: high growth requires investment. Below 40 with negative margin: bad. Above 40 with negative margin: acceptable early. Above 40 with positive margin: great. Top: positive margin + 30% growth = 40+ (mature). Most: rule of 40 includes both. Use: cash + non-GAAP. Be honest." },
    { q: "How do I calculate Burn Multiple accurately?", a: "Formula: net burn / net new ARR. Net burn = gross burn - revenue. Net new ARR = ending ARR - starting ARR + churn. Track: monthly, rolling 12 months. For $100K net burn, $200K net new ARR: 0.5x. Most: quarterly review. Tools: Fathom, Mosaic, custom. Compare: by stage (seed vs Series A). Most: <1x is the goal. Top: <0.5x. Avoid: 2x+ (inefficient). Be consistent: methodology matters." },
    { q: "Should Rule of 40 use growth or ARR growth rate?", a: "Either, but specify. ARR growth: 1) YoY (year over year), 2) QoQ (quarter over quarter). Use TTM for stability. Most: YoY TTM. For 50% YoY: 50. For 30% QoQ annualized: 130% (not directly comparable). Investors: prefer TTM YoY. Be consistent. Most: track monthly, show TTM. Avoid: 1-month spike (skews). Use: trailing 12 months or last 4 quarters. Most: 30%+ YoY + 10%+ margin = 40 (pass)." },
  ],
  howToUse: [
