...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I measure productivity ramp?", a: "Track: 1) Output vs. senior peers (story points, tickets, design output), 2) Quality (bugs, customer feedback), 3) Velocity over time (PRs/week, calls/week), 4) Independence (questions asked, decisions made). Use: weekly check-ins, monthly review, peer feedback. Aim: 70% by month 3, 90% by month 6." },
