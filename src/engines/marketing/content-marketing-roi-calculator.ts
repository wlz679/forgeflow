...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good ROI for content marketing?", a: "Average: 3-5x. Top performers: 10-30x. Hubspot: content marketing generates 3x more leads per dollar than paid search. B2B SaaS: 6-9x ROI typical. E-commerce: 4-6x. Time horizon: 6-12 months to see ROI. Faster for SEO, longer for thought leadership. Track per piece, by cluster, by channel. Calculate: (revenue - cost) / cost." },
    { q: "How do I measure content marketing ROI?", a: "Formula: ROI = (revenue_attributed - content_cost) / content_cost. Attribution: 1) First-touch (first interaction), 2) Last-touch (final interaction), 3) Multi-touch (weighted). Tools: HubSpot, Google Analytics 4, custom UTM. Best: combination of attribution + survey. Most teams: 60-80% of revenue can be tied to content if tracked well." },
    { q: "How much should I budget for content marketing?", a: "B2B SaaS: 25-50% of marketing budget. E-commerce: 15-25%. SMB: 10-20% of revenue. Mix: 50% in-house writers + tools, 30% promotion, 20% paid distribution. Per piece cost: $100-2000 (in-house to agency). Annual content budget: $50K-500K typical. Most teams: $1000-3000/article for high-quality." },
    { q: "What content drives the most ROI?", a: "Top formats: 1) Comparison posts (X vs Y): high intent, 5-10% conversion, 2) How-to guides: SEO traffic, 3) Templates/tools: lead magnets, 4) Original research: backlinks, 5) Case studies: bottom-funnel, 6) Product reviews: high conversion. Allocate: 30% top-of-funnel (awareness), 50% middle (consideration), 20% bottom (decision)." },
    { q: "How long until content marketing pays back?", a: "SEO content: 6-12 months. Paid distribution: 1-3 months. Email nurture: 1-6 months. Social: 3-12 months. Overall: 6-12 months for positive ROI. Be patient: most teams underestimate by 50%. Compound effect: 1.5-2x year-over-year. After 2-3 years: content is the #1 lead source for most B2B. Don't quit early." },
    { q: "How do I scale content production?", a: "Pillars: 1) Hire dedicated writers (1-3 FTE per 100+ articles/year), 2) Editorial calendar (quarterly themes), 3) Templates + SOPs, 4) AI-assisted writing, 5) Subject matter expert interviews, 6) Repurpose (1 article → 10 social posts). Most teams: 4-8 articles/month with 1-2 writers. Top performers: 20-40 articles/month with team." },
    { q: "Should I use AI for content?", a: "Yes, with guardrails. AI helps: 1) Outlines + first drafts (50% faster), 2) Topic research, 3) Meta descriptions, 4) Translation, 5) Email/chat copy. Avoid: full AI articles without human edit (Google penalizes). Best: human + AI collaboration. Top teams: 30-50% content productivity boost with AI. Quality must remain high." },
    { q: "How do I track content marketing attribution?", a: "Tools: 1) UTM parameters on every link, 2) Google Analytics 4 (engagement, conversion), 3) HubSpot/Marketo (B2B attribution), 4) First-party data (email, accounts), 5) Post-purchase surveys (\"how did you hear about us?\"). Best: multi-touch attribution. Most teams: 30-50% revenue attribution. Track: source, medium, campaign, content piece." },
  ],
  howToUse: [
