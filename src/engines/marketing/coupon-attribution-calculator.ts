...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good coupon redemption rate?", a: "Benchmarks: 1-5% of issued coupons. Top campaigns: 10-20%. By discount: 5% off: 3-5%, 10% off: 5-10%, 20% off: 10-15%, 30%+ off: 15-25%. Expiration date: 1-2 weeks optimum. Limited-time: 2-3x redemption vs. open-ended. Best: 10-15% off + 7-day expiration + email reminder." },
    { q: "How do I prevent coupon abuse?", a: "Tactics: 1) One per customer (email/account limit), 2) Minimum order size, 3) Exclude sale items, 4) Limited duration, 5) New customers only, 6) Unique codes per channel, 7) Cap redemptions, 8) Fraud detection (multiple accounts same address). Most teams: 5-10% of coupon redemptions are abuse. Track: redemption rate vs. new customer count." },
