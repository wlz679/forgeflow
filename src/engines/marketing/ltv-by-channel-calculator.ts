...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good LTV:CAC ratio?", a: "Benchmarks: 1:1 = break-even, 3:1 = healthy, 5:1 = under-investing, 10:1 = excellent. SaaS: 3:1+. E-commerce: 2:1+. Below 2:1 = scaling issues. Above 5:1 = invest more. The gold standard: 3-4x. By stage: 1:1 is good for early traction, 3:1+ for scaling. Calculate: (LTV × gross_margin) / CAC. Don't forget gross margin." },
    { q: "How do I improve LTV by channel?", a: "Tactics: 1) Better targeting (right audience for each channel), 2) Better onboarding (activation), 3) Retention (reduce churn), 4) Upsell/cross-sell, 5) Loyalty programs, 6) Win-back. Most teams: 30-50% LTV improvement in 12 months. Biggest lever: retention (cuts churn 1% = 5-10% LTV lift). Track: monthly cohort LTV. Optimize lowest LTV channel first." },
