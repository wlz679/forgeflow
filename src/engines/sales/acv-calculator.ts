...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is the difference between ACV and ARR?", a: "ACV: average contract value (per year, normalized). ARR: annual recurring revenue (annualized run rate). ACV: per customer, per year. ARR: total, per year. For 10 customers at $10K ACV: $100K ARR. ACV + customer count = ARR. ACV for: sales effectiveness, segmentation. ARR for: growth, valuation. Most: both metrics tracked. ACV drives per-rep productivity." },
    { q: "How do I increase ACV?", a: "Top tactics: 1) Tiered pricing (anchor high), 2) Annual prepay discount (locks in higher value), 3) Add-ons (premium features, services), 4) Multi-year deals (15-20% off), 5) Bundling related products, 6) Usage-based add-ons. Most: 10-30% ACV lift in 12 months. Best: tiered pricing + annual prepay. Avoid: just raising prices (loses deals). Test: 5-10% price increase = 2-5% close rate drop." },
    { q: "What is a good ACV for SaaS?", a: "Benchmarks: 1) SMB: $5-15K/year, 2) Mid-market: $30-100K, 3) Enterprise: $100K-1M+. By product: vertical SaaS 2-3x horizontal. Most: aim for $30K+ ACV for venture-scale. Below $10K: very high volume required. Above $100K: longer sales cycle, fewer deals. By stage: seed $5-15K, Series A $20-50K, Series B $50-100K. ACV is the #1 driver of CAC payback." },
