...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is sales velocity?", a: "Sales velocity = (deals × ACV × win_rate) / sales_cycle_length. Measures: how fast you generate revenue. For 10 deals × $50K × 30% / 60 days = $2,500/day = $75K/month. Higher velocity = faster growth. Benchmarks: vary by segment. Most: 1) SMB: $50-100K/day, 2) Mid-market: $20-50K/day, 3) Enterprise: $5-20K/day. Increase: more deals, higher ACV, higher close rate, shorter cycle. Most: 1 lever at a time." },
    { q: "How do I increase sales velocity?", a: "Four levers: 1) More deals (more leads, more reps), 2) Higher ACV (better pricing, upsell), 3) Higher close rate (better qualification, training), 4) Shorter cycle (better tools, process). Most: 20-50% velocity increase in 6-12 months. Top tactics: 1) Better leads + 4) Shorter cycle. Optimize one at a time. Most: track velocity monthly. Aim: 30-50% YoY increase is good." },
    { q: "What is a good sales velocity by company size?", a: "Benchmarks: 1) <$1M ARR: $1-3K/day, 2) $1-10M ARR: $5-20K/day, 3) $10-100M ARR: $20-100K/day, 4) $100M+ ARR: $100K+/day. For 10-person team: $5-20K/day. For 50-person: $50-200K/day. Most: doubling velocity year-over-year is the goal. Track: monthly, by segment. Compare: actual vs target. Most teams: under-velocity = under-scaling." },
    { q: "What is the relationship between sales velocity and CAC payback?", a: "Velocity × gross margin = revenue per day. CAC payback = CAC / (velocity × gross margin / days). For $30K CAC, $5K velocity/day, 80% margin: payback = 30/4 = 7.5 days (great). Real: 12-24 months. Most: faster velocity = faster payback. Aim: <18 months. Velocity affects: 1) Capital efficiency, 2) LTV:CAC, 3) Cash flow. Best: increase velocity (more revenue) + decrease CAC (better efficiency)." },
    { q: "How do I track sales velocity over time?", a: "Track monthly: 1) # of new opportunities, 2) ACV (average deal size), 3) Win rate, 4) Sales cycle. Calculate: velocity = (deals × ACV × win_rate) / cycle_days. Track: monthly trend. Most: 5-10% monthly velocity increase is the goal. Tools: CRM, dashboards. Most teams: review monthly. Most important: trend, not absolute. Plateaus: signal of saturation or inefficiency." },
    { q: "What is the difference between sales velocity and pipeline velocity?", a: "Sales velocity: revenue generated per day (closed deals). Pipeline velocity: movement of deals through pipeline. Sales velocity: end metric. Pipeline velocity: process metric. Most: track both. Pipeline velocity: deals advancing per week. Sales velocity: dollars closed per day. For forecasting: pipeline velocity. For board: sales velocity. Most teams: weekly pipeline review, monthly sales velocity." },
    { q: "How do I use sales velocity for hiring?", a: "Hiring math: 1) Calculate current velocity per rep, 2) Project next year's velocity, 3) Calculate gap, 4) Hire = gap / per-rep velocity. For $5M target, 10 reps at $500K/year: need 10 reps. Add 1-2 for ramp, attrition. Most: 1 rep per $300-500K. For $5M target: 10-15 reps. Plan: 12-18 months ahead. Most: cost per hire is $50-100K. Use: velocity-driven hiring plan." },
    { q: "What is the best way to improve win rate?", a: "Top tactics: 1) Better qualification (BANT, MEDDIC), 2) Better discovery (find pain), 3) Better demo (relevant to buyer), 4) Better follow-up (cadence), 5) Better tools (CRM, enablement), 6) Better training (methodology). Most: 5-10 pp win rate lift in 6 months. Aim: 25-35% (from 20-25%). Best: 1) Qualification + 2) Discovery. Most: 1 pp win rate = 5-10% revenue. Measure: weekly, by rep." },
  ],
  howToUse: [
