...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good quota attainment for sales reps?", a: "Benchmarks: 1) Top 10%: 120%+, 2) Above average: 100-120%, 3) Average: 80-100%, 4) Below average: 50-80%, 5) Failing: <50%. Distribution: 50% hit quota, 25% miss slightly, 25% miss significantly. 60-70% hit quota. 40-50% hit. Most important: trend over time. 100% quota: realistic for top 50%. design quotas so 50% of reps can hit." },
    ...
    { q: "Should quotas be team or individual?", a: "individual quotas (clear ownership). Some: team quotas (cooperation). Hybrid: individual + team spiff. Most teams 70/30 individual/team. Reasons: 1) Individual accountability, 2) Fair comp, 3) Easier to manage. Team: 1) Joint deals, 2) Complex sales, 3) Cross-sell. For SMB: individual. For enterprise: team (multiple stakeholders). individual primary, team incentive for cooperation." },
  ],
  howToUse: [
