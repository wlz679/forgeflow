...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good quota attainment for sales reps?", a: "Benchmarks: 1) Top 10%: 120%+, 2) Above average: 100-120%, 3) Average: 80-100%, 4) Below average: 50-80%, 5) Failing: <50%. Distribution: 50% hit quota, 25% miss slightly, 25% miss significantly. Top SaaS: 60-70% hit quota. Most: 40-50% hit. Most important: trend over time. 100% quota: realistic for top 50%. Most: design quotas so 50% of reps can hit." },
    { q: "How is quota set for SaaS sales reps?", a: "Quota = (rep base × carry × ramp) + new business. For 1 rep at $80K base, 0.5x carry, 100% ramp: $80K + $40K (variable) = $120K. Add OTE (on-target earnings). Most: 50/50 base/variable. Quota: 4-5x OTE variable. For $80K variable: $320-400K quota. Top: 5-6x. Conservative: 3-4x. Most: set so 50% of reps can hit. By segment: SMB 4x, mid-market 4-5x, enterprise 3-4x." },
    { q: "What is a typical ramp time for new sales reps?", a: "Benchmarks: 1) SMB: 3-6 months, 2) Mid-market: 6-9 months, 3) Enterprise: 9-12 months, 4) Inbound/PLG: 1-3 months. Most: 6 months average. Plan: 50% in month 1, 75% in month 2, 100% in month 3. Realistic: 80% in month 6. For 6-month ramp: Y1 quota is 70% of annual. Most teams: track ramp-adjusted quota. 18-month ramp: 50% of Y1 quota, 75% Y2, 100% Y3." },
    { q: "How do I improve quota attainment?", a: "Top tactics: 1) Better lead quality (marketing), 2) Sales training (methodology), 3) Better tools (CRM, enablement), 4) Shorter ramp (onboarding), 5) Better qualification, 6) Coaching. Most: 10-20 pp improvement in 12 months. Aim: 60% hitting quota (vs 40-50%). Best: 1) Lead quality + 4) Shorter ramp. Most teams: 2-3x ROI on sales enablement investment." },
    { q: "What is the difference between quota and OTE?", a: "Quota: sales target (revenue). OTE: on-target earnings (base + variable). For 50/50 split at $200K OTE: $100K base + $100K variable. Variable: tied to quota. For 100% quota: $100K variable. For 50%: $50K. Most: 50/50 split. Higher split (60/40): more variable = more risk. Lower split (40/60): less risk. Quota: typically 4-5x variable. For $100K variable: $400-500K quota." },
    { q: "What is the relationship between quota and ACV?", a: "Quota = ACV × deals_per_rep_per_year. For $50K ACV, 10 deals/year: $500K quota. For $30K ACV, 15 deals: $450K. For $100K ACV, 5 deals: $500K. Most: $400-600K quota for mid-market. ACV drives: 1) Deal volume needed, 2) Cycle time, 3) Rep productivity. Higher ACV: longer cycle, more strategy, more support. Lower ACV: more volume, more process. Most teams: $30-50K ACV for \"good\" quota." },
    { q: "How do I handle underperforming reps?", a: "Process: 1) Diagnose (skill vs effort vs territory), 2) PIP (30/60/90 day plan), 3) Coaching (call reviews, training), 4) Territory swap, 5) Exit. Most: 60-90 day window. If <50% attainment after 6 months in role: PIP. 80% of underperformance: wrong hire, wrong territory, wrong fit. Address quickly. Cost: $200-500K to replace. Avoid: keeping underperformers (team morale)." },
    { q: "Should quotas be team or individual?", a: "Most: individual quotas (clear ownership). Some: team quotas (cooperation). Hybrid: individual + team spiff. Most teams: 70/30 individual/team. Reasons: 1) Individual accountability, 2) Fair comp, 3) Easier to manage. Team: 1) Joint deals, 2) Complex sales, 3) Cross-sell. For SMB: individual. For enterprise: team (multiple stakeholders). Most: individual primary, team incentive for cooperation." },
  ],
  howToUse: [
