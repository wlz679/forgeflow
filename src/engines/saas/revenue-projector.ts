...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I project revenue for a SaaS?", a: "Project: 1) MRR growth (3-15% MoM for early), 2) New MRR per month, 3) Churn (1-3% monthly), 4) Expansion (5-15% per cohort). Bottom-up: cohort-based (each cohort grows/shrinks). Top-down: market × share. Most: bottom-up is more accurate. Tools: Excel, Google Sheets, Mosaic, Pigment. Update monthly. Compare: actual vs forecast. Adjust assumptions quarterly." },
    { q: "What is a realistic monthly growth rate for SaaS?", a: "Benchmarks: 1) Early-stage (0-$1M ARR): 15-20% MoM, 2) Growth ($1-10M ARR): 5-10% MoM, 3) Scale ($10-100M ARR): 3-5% MoM, 4) Enterprise ($100M+ ARR): 1-3% MoM. Year-over-year: 200%+ T1, 100%+ T2, 50%+ T3, 30%+ T4. Most: aim for T2 growth at scale. Sustainable: 5-10% MoM. T2G3 (T2 to T3 transition) is hardest." },
    { q: "How do I build a 3-statement financial model?", a: "Three statements: 1) Income statement (revenue, COGS, opex, profit), 2) Balance sheet (assets, liabilities, equity), 3) Cash flow (operating, investing, financing). SaaS: revenue = MRR + new, costs = fixed + variable, cash = revenue - costs. Most: 3-5 year model, monthly granularity. Tools: Excel, Fathom, Mosaic. Update monthly. Investor model: 5 years, 3 scenarios (base, up, down)." },
    { q: "What is the right way to model revenue for usage-based pricing?", a: "Usage-based: 1) Customer count, 2) Usage per customer, 3) Price per unit. For 100 customers at 100K API calls/month at $0.001/call: $10K MRR. Track: usage distribution (not average). Most: top 10% of customers = 50% of usage. Model: cohort-based with usage growth. Update: weekly. Tools: Stripe Sigma, Metronome, Orb. Best: 3-5 year cohort model with usage distribution." },
    { q: "What assumptions should I use in a revenue projection?", a: "Critical assumptions: 1) MRR growth rate (decline over time), 2) New MRR per month, 3) Churn rate, 4) Expansion rate, 5) CAC, 6) LTV. For seed: 1) 10-15% MoM growth, 2) 1-3% monthly churn, 3) 2:1 LTV:CAC. Sensitivity: build 3 scenarios. Best: validate with cohort data after 6 months. Update quarterly. Most: bottom-up assumptions beat top-down. Use: real customer data." },
    { q: "How do I show runway and dilution in projections?", a: "Runway = cash / burn. Show: 1) Cash on hand, 2) Monthly burn, 3) Months of runway. Dilution: 1) Current ownership, 2) Future rounds (% dilution), 3) Liquidation preferences. For 5-year model: 1) Pre-seed/seed: 18-24 months runway, 2) Series A: 12-18 months runway target, 3) Series B: 18-24 months. Most: 2-3 years visibility needed. Show: when you raise next + how much." },
    { q: "What is a good ARR projection for a seed-stage SaaS?", a: "Year 1: $100-500K ARR. Year 2: $500K-2M. Year 3: $1-5M. By year 3: $1M+ ARR is \"good\" (Series A ready), $3M+ is \"great\". Most: aim for $1M ARR in 18-24 months (rule of 40 friendly). Track: MRR × 12 = ARR. T2D3: Triple, Triple, Double, Double, Double. Best in class: $5M ARR in 3 years from seed. Most: $1-3M ARR in 3 years is realistic." },
    { q: "How do I account for seasonality in revenue projections?", a: "Seasonality: 1) Most industries: Q4 spike (B2C), 2) B2B: Q1, Q3 slower, 3) Education: Sep-Dec, 4) Tax software: Jan-Apr. Build: monthly model with seasonality factors. Example: 30% Q4, 25% Q1, 20% Q2, 25% Q3. Use: 3+ years of historical data. Avoid: linear projection. Most: 20-40% revenue swing between quarters is normal. Update: as data emerges. Tool: cohort + seasonality model." },
  ],
  howToUse: [
