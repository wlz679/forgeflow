...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is the difference between gross burn and net burn?", a: "Gross burn: total monthly operating expenses (before revenue). Net burn: gross burn - monthly revenue. For $50K expenses, $20K revenue: gross burn $50K, net burn $30K. Track both. Gross burn: cost discipline. Net burn: cash depletion rate. Investors: focus on net burn. Net burn × months of cash = runway. Most: gross burn growing, net burn shrinking (as revenue grows)." },
    ...
    { q: "What is a healthy burn multiple?", a: "Burn multiple = net burn / net new ARR. Measures capital efficiency. Benchmarks: 1) <0.5x: capital efficient, 2) 0.5-1x: healthy, 3) 1-2x: average, 4) 2-3x: concerning, 5) >3x: inefficient. Best: <1x. For $100K net burn, $200K new ARR: 0.5x. Top performers: 0.3-0.5x. Investors: key efficiency metric. Most teams: 0.7-1.5x. Target: <1x." },
    { q: "How do I extend my runway without raising?", a: "Top tactics: 1) Cut non-essential costs (audit subscriptions, freeze hiring), 2) Renegotiate vendor contracts, 3) Convert fixed to variable (3PL vs in-house), 4) Slow growth (target profitability), 5) Pre-sell annual contracts, 6) Issue invoices early. Most: 20-50% cost reduction possible. Time: 1-3 months. Use: 18-month runway = default to profitability. Avoid: 1 round away from zero." },
    { q: "What is a good burn rate for an early-stage startup?", a: "Depends on stage: 1) Pre-seed: $20-50K/month, 2) Seed: $50-150K, 3) Series A: $150-500K, 4) Series B: $500K-2M. Most: stage-appropriate. For $5M raised: burn $200-300K/month, 18-24 month runway. Track: burn/capital ratio. Aim: 60-70% of capital on people, 10-20% on product/engineering, 10-20% on sales/marketing, 5-10% G&A. Optimize: highest-ROI spend." },
