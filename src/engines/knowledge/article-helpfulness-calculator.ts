...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I measure if an article is helpful?", a: "Track: 1) \"Was this helpful?\" thumbs up/down (per article), 2) Follow-up ticket creation (article not solving problem), 3) Time on page (engagement depth), 4) Bounce rate (users leaving immediately), 5) Search-to-resolution rate. Best: helpful % + ticket creation correlation. Target: 80%+ helpful, <10% ticket creation after view." },
    ...
    { q: "How long should KB articles be?", a: "Sweet spot: 300-800 words. Too short: insufficient detail. Too long: users lost. Use: short intro (1-2 sentences), step-by-step (max 5-7 steps), FAQ, related links. For complex topics: split into multiple articles. Best: 1 page = 1 task. Pattern: 80% of articles <1000 words. Long-form only for detailed tutorials." },
