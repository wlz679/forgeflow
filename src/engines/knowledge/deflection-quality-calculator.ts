...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I improve deflection quality?", a: "Tactics include 1) Better search (Algolia, AI search), 2) AI chatbot for natural language queries, 3) Content audit (top 100 articles quarterly), 4) User research (where do users get stuck?), 5) Improve article helpfulness (track feedback). Most teams 20-40% improvement in quality in 6 months. Aim for deflection rate >40% AND quality >70%." },
