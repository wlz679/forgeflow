...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is KB coverage rate?", a: "KB coverage = % of common user questions answered by KB articles. Formula: answered_questions / total_questions. Targets: 60-80% is good. 80%+ is excellent. Track by: topic, product area, user segment. Top performers: 90%+ coverage. Below 50%: lots of gap. Top 20 articles typically cover 80% of common questions. Focus on top 100 first." },
