...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good supplier score?", a: "Scoring: 9-10: strategic partner. 8-9: preferred supplier. 6-8: approved. 4-6: conditional. <4: replace. Most: 80%+ of spend on 8+ suppliers. Replace: <6 score for 2+ quarters. Review: top 20 suppliers quarterly. Long tail: annually. Most teams: 5-10% of suppliers replaced per year. Goal: continuous improvement." },
    { q: "How often should I review suppliers?", a: "Top suppliers: quarterly. Mid-tier: biannually. Long tail: annually. Triggers: 1) Quality issue, 2) Delivery miss, 3) Cost increase, 4) Compliance issue, 5) Market change. Most: 80% of issues from 20% of suppliers. Track: 5-10 KPIs per supplier. Tools: SAP, Coupa, custom spreadsheet. Most teams: 1-2 hours per supplier per review." },
    ...
    { q: "How do I handle a failing supplier?", a: "Process: 1) Document issues (scorecard), 2) Communicate expectations, 3) Set improvement timeline (30-90 days), 4) Provide support if strategic, 5) Find alternative (qualify new supplier), 6) Transition gradually. Most: 60-90 days to fix. If no improvement: 6-12 month transition. Avoid: sudden termination (operational risk). Most teams: 5-10% of suppliers fail per year." },
    { q: "What is the cost of supplier quality issues?", a: "Cost of poor quality (COPQ): 1) Defects (rework, scrap): 1-5% of revenue, 2) Warranty: 1-3%, 3) Returns: 1-3%, 4) Customer churn: 5-15%, 5) Inspection costs: 0.5-2%, 6) Internal time: 1-2%. Total: 5-20% of revenue. Most manufacturers: 5-15% COPQ. Top performers: <3%. Tactics: scorecards, audits, CAPA (corrective action plans)." },
  ],
  howToUse: [
