...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "What is a good inventory turnover ratio?", a: "Benchmarks: 4-6x/year is good. 8-12x is excellent. <3x = overstocked. >15x = risk of stockouts. By industry: grocery 12-20x, apparel 4-8x, electronics 6-10x, auto 2-4x, hardware 3-5x. Calculate: COGS / average inventory. Higher = more efficient. Sweet spot: industry-specific. Most ecommerce: 6-10x." },
    { q: "How do I improve inventory turnover?", a: "Top tactics: 1) Better demand forecasting, 2) Reduce safety stock, 3) Markdown slow-movers, 4) Negotiate smaller MOQs with suppliers, 5) Drop ship long-tail, 6) Improve product mix (data-driven), 7) Bundle slow items. Most teams: 20-50% improvement in 12 months. Aim: industry average + 50%. Track by category, not just overall." },
    ...
    { q: "How do I calculate turnover for multi-product businesses?", a: "Methods: 1) Total: COGS / average inventory (across all products), 2) By category: per category, 3) By SKU: per product, 4) Pareto: top 20% of SKUs = 80% of revenue. Best: per category. Top 20 SKUs: track closely. Long tail: 80% of SKUs = 20% of revenue. Use: identify problem SKUs, optimize portfolio. Most teams: monthly review of low-velocity items." },
  ],
  howToUse: [
