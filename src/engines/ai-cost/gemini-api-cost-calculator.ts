...
const customFn =
  "var M={'gemini-3.5-flash':{i:1.5,o:9,bi:0.375,bo:2.25,n:'Gemini 3.5Flash',f:'flash35',ic:'●',cw:'1M',od:1,sc:true,sb:true},'gemini-3.1-pro':{i:2,o:12,bi:1,bo:6,n:'Gemini 3.1 Pro',f:'pro',ic:'▲',cw:'1M',od:2,sc:true,sb:true},'gemini-3-flash':{i:0.5,o:3,bi:0.25,bo:1.5,n:'Gemini 3 Flash',f:'flash3',ic:'◆',cw:'1M',od:3,sc:true,sb:true},'gemini-2.5-flash':{i:0.3,o:2.5,bi:0,bo:0,n:'Gemini 2.5Flash',f:'legacy',ic:'◇',cw:'1M',od:4,sc:false,sb:false},'gemini-1.5-pro':{i:3.5,o:10.5,bi:0,bo:0,n:'Gemini 1.5 Pro',f:'legacy',ic:'◇',cw:'2M',od:5,sc:false,sb:false},'gemini-1.5-flash':{i:0.075,o:0.3,bi:0,bo:0,n:'Gemini 1.5 Flash',f:'legacy',ic:'◇',cw:'1M',od:6,sc:false,sb:false}};" +
...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "Is Gemini really cheaper than GPT or Claude?", a: "Gemini 1.5 Flash ($0.075/$0.30) is 5-10x cheaper than GPT-5 or Claude Sonnet for comparable quality on simple tasks. Gemini 2.5 Pro ($1.25/$10) is mid-tier. For high-volume simple workloads (classification, extraction, routing), Flash is the most cost-effective major model." },
    { q: "What is special about Gemini context window?", a: "Gemini 1.5 Pro offers 2M tokens context (vs 200K for Claude, 128K for GPT). Best for: long documents, video analysis (1 hour of video = ~250K tokens), code repos. For 1M-token context, Flash charges $0.075/1M input — extremely cheap for big contexts." },
    { q: "How does Gemini free tier compare?", a: "Google AI Studio offers free Gemini 1.5 Flash usage: 15 requests/minute, 1,500/day, 1M tokens/minute. This is the most generous free tier of any major provider. Use it for: prototypes, learning, low-volume personal projects. Upgrade to paid once you exceed the limit." },
    { q: "Should I use Gemini for production apps?", a: "Yes for most use cases. Gemini 1.5 Flash quality is now competitive with GPT-4o for many tasks. Multimodal (text, image, video, audio) is included. Limitation: rate limits and availability vary by region. Latency is 1-2s vs 200-500ms for GPT-4o." },
    { q: "What are the pricing tiers for Gemini 2.5?", a: "Gemini 2.5 Flash ($0.075/$0.30) — cheap, fast. Gemini 2.5 Pro ($1.25/$10) — reasoning, complex tasks. Gemini 2.5 Pro Deep Think (premium tier) — for the hardest problems. For most use cases, Flash is sufficient; upgrade to Pro only when Flash quality fails." },
    { q: "How does Gemini handle multimodal input?", a: "Image input: $0.0015/image (Flash). Video: $0.002/second. Audio: $0.001/second. Multiple modalities in one request: billed per modality. For vision apps, Gemini is often 5-10x cheaper than GPT-4o vision. Document processing (PDFs) is included at text-token rates." },
    { q: "What is the difference between AI Studio and Vertex AI?", a: "AI Studio is consumer/developer-friendly, free tier included, fastest to prototype. Vertex AI is enterprise, has SLAs, VPC-SC, data residency, IAM, higher rate limits. Same models, same prices. Use AI Studio for prototyping, Vertex for production at scale." },
    { q: "How do I optimize Gemini API costs?", a: "Use caching (50% off for repeated context). Use Flash for high-volume simple tasks. Batch processing: 50% off for async. Avoid unnecessary long contexts — fetch only relevant chunks. Use system instructions efficiently (no fluff). Monitor usage in Google Cloud Console." },
  ],
  howToUse: [
