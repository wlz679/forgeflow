...
const customFn =
  "var M={'deepseek-v4-flash':{i:0.44,o:1.32,n:'Deepseek V4Flash',f:'v4',cw:'1M',od:1},'deepseek-v4-pro':{i:1.32,o:3.96,n:'Deepseek V4Pro',f:'v4',cw:'1M',od:2},'deepseek-v4-pro-promo':{i:0.435,o:0.87,n:'V4 Pro (75% Promo)',f:'v4',cw:'1M',od:3},'deepseek-r1':{i:0.55,o:2.19,n:'Deepseek R1',f:'legacy',cw:'66K',od:4}};" +
...
const engine: ToolEngine = {
  ...
  staticExamples: [
    ...
    '\n🔴 DeepSeek API Cost\n\n📥 Input: 1,000 tokens/req | 📤 Output: 500 tokens/req | 🔄 100 reqs/day\n\n📊 Cost Comparison (100 reqs/day)\n──────────────────────────────────────────────────────\n◆ Deepseek V4Flash         █████████████                            $3.30\n◆ Deepseek V4Pro           ████████████████████████████████████████ $9.90\n◆ V4 Pro (75% Promo)       ███████████                              $2.61\n◇ Deepseek R1              ████████████████████                     $4.94\n◇ Deepseek Chat            ██████                                   $1.47\n◇ Deepseek Reasoner        ██████                                   $1.47\n◇ Deepseek Coder           ░░░                                      $0.84 🏆\n◇ Deepseek V3              ██████████                               $2.46\n◇ Deepseek V3.2            ██████                                   $1.44\n\n\n📋 Selected Model Details\n────────────────────────────────────────────────────────────\n◆ Deepseek V4Flash (V4 Series) | Context: 1M\n────────────────────────────────────────────\nInput:  1,000   tokens × $0.44/1M → $0.0004/req\nOutput: 500     tokens × $1.32/1M → $0.0007/req\n────────────────────────────────────────────\nPer request:    $0.0011\nDaily (100):    $0.11\nMonthly (30d):  $3.30\nAnnual:         $39.60\n────────────────────────────────────────────\n\n◆ V4 Pro (75% Promo) (V4 Series) | Context: 1M\n────────────────────────────────────────────\nInput:  1,000   tokens × $0.43/1M → $0.0004/req\nOutput: 500     tokens × $0.87/1M → $0.0004/req\n────────────────────────────────────────────\nPer request:    $0.0009\nDaily (100):    $0.09\nMonthly (30d):  $2.61\nAnnual:         $31.32\n────────────────────────────────────────────\n\n💰 Savings Insights\n────────────────────────────────────────────────────────────\n🏆 Cheapest: Deepseek Coder at $0.84/mo\n⭐ Best value (V4 standard): Deepseek V4Flash at $3.30/mo\n💸 Switching from Deepseek V4Flash to V4 Pro (75% Promo) saves $0.69/mo ($8.28/yr)\n🌍 Deepseek Coder vs GPT-5 Nano: costs $0.09/month more (12% premium)\n🌍 Deepseek Coder vs Claude Haiku 3: saves $1.78/month (68% cheaper)\n🌍 Deepseek Coder vs Gemini 1.5 Flash: costs $0.17/month more (24% premium)\n💡 DeepSeek V4 Flash is 20-100x cheaper than frontier models. Auto-caching saves 98% on repeated prompts.\n\n📅 Usage Scenarios (monthly cost at 100 reqs/day)\n\n◆ Deepseek V4Flash: 50→$1.65 · 100→$3.30 · 500→$16.50 · 1,000→$33.00 · 5,000→$165.00 · 10,000→$330.00\n◆ V4 Pro (75% Promo): 50→$1.30 · 100→$2.61 · 500→$13.05 · 1,000→$26.10 · 5,000→$130.50 · 10,000→$261.00\n\n🩺 Cost Health:\n────────────────────────────────────────────────────────────\n• 🟢 Healthy cost spread (1.3x) across selected models.\n• 🟢 Micro-tier (under $5/mo) — V4 Pro (75% Promo) at $2.61/mo.\n• 💡 Switch to a provider with batch pricing (Anthropic/OpenAI): save ~$2.96/mo (50% discount) if latency is not critical.\n\n🔄 What-If Scenarios:\n────────────────────────────────────────────────────────────\n• Switch cheapest to Deepseek Coder:  save $1.77/mo  (similar quality, much cheaper)\n• Double volume to 200 reqs/day:  $11.82/mo\n• Halve volume to 50 reqs/day:  $2.96/mo\n',
  ],
  faq: [
    ...
    { q: "Why is DeepSeek so cheap?", a: "DeepSeek V4 Flash ($0.14/$0.28) is priced 10-50x below GPT-5/Claude for similar quality on many tasks. Reasons: aggressive market entry pricing, hosted in regions with lower compute costs, business model focused on volume. Quality is competitive for non-reasoning tasks." },
    { q: "Is DeepSeek good enough for production?", a: "For many use cases, yes. DeepSeek V3 handles: classification, extraction, translation, content generation, code, simple chat. Limitations: content filters are stricter, English-only reasoning is weaker than GPT-5, hosted outside the US (latency, data residency concerns)." },
    { q: "What are the data privacy implications?", a: "DeepSeek is hosted in China. For US/EU users, this raises data residency concerns. Do not send PII or regulated data to DeepSeek API. Use it for: anonymous workloads, content generation, code assistance, internal tools. For customer-facing products with PII, prefer US-hosted providers." },
    { q: "Should I use DeepSeek for coding tasks?", a: "DeepSeek Coder V2 ($0.14/$0.28) is competitive with GPT-4o for code generation. Use for: code completion, refactoring, test generation, code review. For complex architecture decisions or multi-repo reasoning, Claude Sonnet 4.6 still wins. Many devs use DeepSeek Coder for the bulk + Sonnet for hard problems." },
    { q: "How does DeepSeek Reasoner compare?", a: "DeepSeek R1 ($0.55/$2.19) is a reasoning model that rivals OpenAI o1 but at 1/10th the price. Use for: math, logic, complex multi-step problems. Slower than flash models (~10-30s latency). Not for: real-time chat. Open-source weights available for self-hosting." },
    { q: "What is the promo pricing on V4 Pro?", a: "V4 Pro (Promo) at $0.27/$1.10 is temporarily discounted 75% off list. Promo pricing may change — check current pricing. Suitable for production workloads that can survive a price increase. For long-term cost certainty, use V4 Flash which is sustained low pricing." },
    { q: "How do I switch to DeepSeek from OpenAI?", a: "DeepSeek API is OpenAI-compatible. Change base URL to api.deepseek.com, swap API key. Most OpenAI SDKs work with one config change. Existing code runs unchanged. Test quality on your specific use case before fully switching — some prompts may need re-tuning." },
    { q: "What are the rate limits on DeepSeek?", a: "Free tier: minimal. Pay-as-you-go: 100-1000+ requests/minute depending on model and tier. Higher tiers available for enterprise. Soft limits on concurrent requests. Use batching and backoff to handle. Always implement retry logic." },
  ],
  howToUse: [
