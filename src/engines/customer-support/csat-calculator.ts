...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "Should I ask CSAT after every interaction?", a: "For support tickets: yes (after resolution). For product usage: only after key milestones (first purchase, feature adoption). Avoid: after every click, every login, every page view. Saturation destroys response rates. Best: 1-2 surveys per customer per month, rotated to avoid fatigue." },
  ],
  howToUse: [
