...
const engine: ToolEngine = {
  ...
  faq: [
    ...
    { q: "How do I increase rental yield?", a: "Tactics: 1) Increase rent (market adjustments, value-add), 2) Reduce vacancy (better marketing, faster turn), 3) Reduce expenses (refinance, management optimization), 4) Add income (parking, storage, laundry), 5) Value-add (renovate, add bedrooms). Most: 1-2% yield improvement per year. Most tactics: 0.5-1% gain. Total: 5-10% yield lift achievable. Higher: more risk (higher rent may mean tenant turnover)." },
  ],
  howToUse: [
