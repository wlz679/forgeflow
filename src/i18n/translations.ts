export const translations: Record<string, { en: string; zh: string }> = {
  ...
  'tools.youtube-video-idea-generator.how_to_use.0': { en: 'Enter your video topic or niche (e.g., "tech reviews" or "cooking").', zh: '输入视频主题或细分领域（如"科技评测"或"烹饪"）。' },
  'tools.youtube-video-idea-generator.how_to_use.1': { en: 'Click "Generate Ideas".', zh: '点击"生成创意"。' },
  'tools.youtube-video-idea-generator.how_to_use.2': { en: 'Review the 10 generated video ideas.', zh: '查看生成的 10 个视频创意。' },
  'tools.youtube-video-idea-generator.how_to_use.3': { en: 'Click Copy on any idea you like, or use Copy All.', zh: '点击任意创意上的"复制"，或使用"复制全部"。' },
  'tools.youtube-video-idea-generator.how_to_use.4': { en: 'Pick your favorite and start creating!', zh: '选择你最喜欢的创意，开始创作！' },
  ...
  'tools.youtube-trending-ideas-finder.how_to_use.0': { en: 'Enter your channel niche.', zh: '输入你的频道细分领域。' },
  'tools.youtube-trending-ideas-finder.how_to_use.1': { en: 'Click "Generate Trending Ideas" for 10 trending directions.', zh: '点击"生成热门创意"获取 10 个热门方向。' },
  'tools.youtube-trending-ideas-finder.how_to_use.2': { en: 'Review each idea and consider how to adapt it to your style.', zh: '查看每个创意，思考如何调整以适应你的风格。' },
  'tools.youtube-trending-ideas-finder.how_to_use.3': { en: 'Copy ideas that resonate with your audience.', zh: '复制能引起观众共鸣的创意。' },
  'tools.youtube-trending-ideas-finder.how_to_use.4': { en: 'Research trends further on YouTube to validate demand.', zh: '在 YouTube 上进一步研究趋势以验证需求。' },
  ...
  'tools.youtube-niche-ideas-generator.how_to_use.0': { en: 'Enter a skill or interest (e.g., "playing piano").', zh: '输入一项技能或兴趣（如"弹钢琴"）。' },
  'tools.youtube-niche-ideas-generator.how_to_use.1': { en: 'Click "Generate Niche Ideas" for 10 suggestions.', zh: '点击"生成细分领域创意"获取 10 个建议。' },
  'tools.youtube-niche-ideas-generator.how_to_use.2': { en: 'Each suggestion combines your interest with audience, style, or format.', zh: '每个建议都将你的兴趣与受众、风格或格式相结合。' },
  'tools.youtube-niche-ideas-generator.how_to_use.3': { en: 'Copy ideas you like and research them on YouTube.', zh: '复制你喜欢的创意，并在 YouTube 上研究它们。' },
  'tools.youtube-niche-ideas-generator.how_to_use.4': { en: 'Pick one niche to start with — you can expand later.', zh: '选择一个细分领域开始——以后可以扩展。' },
  ...
  'tools.youtube-content-planner.how_to_use.0': { en: 'Enter your channel niche.', zh: '输入你的频道细分领域。' },
  'tools.youtube-content-planner.how_to_use.1': { en: 'Select 7 or 30 day plan.', zh: '选择 7 天或 30 天计划。' },
  'tools.youtube-content-planner.how_to_use.2': { en: 'Click "Generate Plan".', zh: '点击"生成计划"。' },
  'tools.youtube-content-planner.how_to_use.3': { en: 'Each day gets a unique video topic. Copy individually or full plan.', zh: '每天都有一个独特的视频主题。可单独复制或复制整个计划。' },
  'tools.youtube-content-planner.how_to_use.4': { en: 'Customize to fit your style.', zh: '自定义以适应你的风格。' },
  ...
  'tools.youtube-viral-video-ideas.how_to_use.0': { en: 'Enter your topic or content area.', zh: '输入你的主题或内容领域。' },
  'tools.youtube-viral-video-ideas.how_to_use.1': { en: 'Click "Generate Viral Ideas" for 10 concepts.', zh: '点击"生成爆款创意"获取 10 个概念。' },
  'tools.youtube-viral-video-ideas.how_to_use.2': { en: 'Each uses a proven viral format.', zh: '每个都使用经过验证的爆款格式。' },
  'tools.youtube-viral-video-ideas.how_to_use.3': { en: 'Copy ideas with clear hooks that fit your style.', zh: '复制具有清晰钩子且适合你风格的创意。' },
  'tools.youtube-viral-video-ideas.how_to_use.4': { en: 'Execution matters more than the idea — great ideas fail with poor delivery.', zh: '执行比创意更重要——好的创意也可能因糟糕的执行而失败。' },
