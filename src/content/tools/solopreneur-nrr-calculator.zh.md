...
出去，只看你已到手的那块收入健不健康。拆解到组件，NRR = (期初 MRR +
扩展 MRR − 缩减 MRR − 流失 MRR) ÷ 期初 MRR × 100，扩展与流失是两大
对立组件——扩展越强、LTV/CAC 越稳，流失越压、复利越厚；OpenView
SaaS 基准报告顶四分位企业 NRR > 120%、中位数 ~110%，这是估值溢价
的硬门票。
...
投资人沟通时务必同步看 trailing 12-month NRR。另外，B2B 多走席位扩
展 + 涨价，NRR 天然高；B2C 自服务订阅以续费为主，扩展通道几乎关闭，
top-quartile NRR 通常只有 100–110%。多币种收入按期末汇率折算时，
汇率波动会人为放大或压缩 NRR——评估跨境订阅务必用恒定汇率重算。
