...
这是稳态模型。它抓不住季节性（黑五/双 12 峰值工单量常常是月均的
1.8–2.5 倍、SaaS 产品发布的工单尖刺可达月均 3 倍），也抓不住坐席流
失——联络中心行业年化主动流失率约 30–40%、初次上岗 90 天内流失约
25%（TSIA Workforce Optimization Benchmark 2024）。Backlog 清理
时间存在方差：P1 工单 24 小时 SLA 通常把单工单处理时长推到平均的 2–8
倍，离群工单甚至 12 倍以上。7×24 团队还要在人头之上叠排班模式。最终
签批前，叠一层季节性、排班覆盖和流失重算。
