...
行业基准来自 Zendesk《Customer Experience Trends 2024》和 Salesforce
《State of the Service》：B2B SaaS 单工单成本普遍落在 $15–$50 区间，
其中一线坐席人力约占 60–70%（含薪资、福利、办公分摊）、工具与许可
（CRM、知识库、电话系统）占 15–20%，培训与质控摊销占 5–10%。
看清这个结构后，预算该往增人、扩工具还是补知识库分流才能做出理性取舍。
