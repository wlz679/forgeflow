...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    description:
      'Compute overall sales win rate as a multiplicative funnel across 4 stage transitions (SQL→Opp→Proposal→Negotiation→Won) and identify the bottleneck stage. Reveals which transition is leaking the most deals.',
    categoryId: 'S',
    applicationCategory: 'BusinessApplication',
    inputs: [
      { name: 'sqlEntered', label: 'SQL entered', placeholder: '100', type: 'number' },
      { name: 'sqlAdvanced', label: 'SQL → Opp advanced', placeholder: '50', type: 'number' },
      { name: 'oppEntered', label: 'Opp entered', placeholder: '50', type: 'number' },
      { name: 'oppAdvanced', label: 'Opp → Proposal advanced', placeholder: '30', type: 'number' },
      { name: 'proposalEntered', label: 'Proposal entered', placeholder: '30', type: 'number' },
      { name: 'proposalAdvanced', label: 'Proposal → Negotiation advanced', placeholder: '20', type: 'number' },
      { name: 'negEntered', label: 'Negotiation entered', placeholder: '20', type: 'number' },
      { name: 'negAdvanced', label: 'Negotiation → Won', placeholder: '15', type: 'number' },
    ],
    keywords: [
      'win rate calculator',
      'sales win rate',
