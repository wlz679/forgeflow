...
export const categories: Category[] = [
  ...
  { id: 'O', name: 'Operations', slug: 'operations-inventory', description: 'Calculate inventory turnover, carrying cost, stockout cost, reorder point, fulfillment cost, and supplier scorecards for Shopify/Amazon FBA sellers and product-based businesses.' },
  { id: 'S', name: 'Sales', slug: 'sales', description: 'Calculate pipeline value, sales velocity, ACV, win rate by stage, quota attainment, and pipeline coverage for B2B SaaS sales teams and RevOps.' },
  ...
  { id: 'K', name: 'Knowledge', slug: 'knowledge', description: 'Calculate KB coverage rate, article freshness, search effectiveness, deflection quality, documentation ROI, and article helpfulness score for DevRel Leads, Documentation Managers, and Technical Writers at mid-market B2B SaaS companies ($10M-$50M ARR).' },
