...
const ENGINES = [
  ...
  { file: 'support-capacity-planning-calculator.ts', slug: 'solopreneur-support-capacity-planning-calculator',
    subdir: 'customer-support', defaultInputs: { monthly_tickets: '5000', avg_handle_time_min: '18', target_occupancy_pct: '70', work_hours_per_month: '160', shrinkage_pct: '30', target_response_time_min: '60' } },
  { file: 'deflection-rate-calculator.ts', slug: 'solopreneur-deflection-rate-calculator',
    subdir: 'customer-support', defaultInputs: { monthly_tickets: '5000', deflection_rate: '35', cost_per_ticket: '24', tool_monthly_cost: '1500', target_deflection: '40' } },
  { file: 'csat-calculator.ts', slug: 'solopreneur-csat-calculator',
    subdir: 'customer-support', defaultInputs: { csat_pct: '87', response_rate: '35', sample_size: '200', target_csat: '90' } },
  ...
  { file: 'course-pricing-calculator.ts',      slug: 'solopreneur-course-pricing-calculator',
    subdir: 'freelance',       defaultInputs: { targetMonthlyIncome: '5000', estimatedBuyersPerMonth: '50', platformFee: '10' } },
  ...
  { file: 'project-profitability-calculator.ts', slug: 'solopreneur-project-profitability-calculator',
    subdir: 'freelance', defaultInputs: { projectRevenue: '5000', hoursEstimated: '40', hourlyCost: '50', materialCost: '200' } },
  ...
  { file: 'email-list-revenue-calculator.ts',  slug: 'solopreneur-email-list-revenue-calculator',
    subdir: 'freelance',   defaultInputs: { subscriberCount: '10000', openRate: '25', clickRate: '5', conversionRate: '2', avgOrderValue: '50', emailsPerMonth: '4', unsubscribeRate: '0.5' } },
  ...
  { file: 'grr-calculator.ts',                       slug: 'solopreneur-grr-calculator',
  ...
  { file: 'customer-health-score-calculator.ts',    slug: 'solopreneur-customer-health-score-calculator',
  ...
  { file: 'cart-abandonment-cost-calculator.ts', slug: 'solopreneur-cart-abandonment-cost-calculator', subdir: 'marketing', defaultInputs: { monthlyTraffic: '50000', cartAddRate: '20', cartAbandonmentRate: '70', avgOrderValue: '80', recoveryRate: '8', recoveryCostPerSend: '0.5' } },
];
