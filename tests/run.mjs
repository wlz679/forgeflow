...
//
// --test-concurrency=1 is mandatory: 7 test files (baselayout-clerk-script,
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 7
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 7 build-dependent suites skipped.');
