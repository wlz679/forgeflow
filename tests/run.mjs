...
//
// --test-concurrency=1 is mandatory: 19 test files (baselayout-clerk-script,
...
// og-meta-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 19
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 19 build-dependent suites skipped.');
  ...
  console.log('[skip-mode]   canonical-url-guard, og-meta-guard');
}
