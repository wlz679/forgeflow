...
//
// --test-concurrency=1 is mandatory: 14 test files (baselayout-clerk-script,
...
// blog-cross-link-cjk-guard, zh-hardcoded-english-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 14
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 14 build-dependent suites skipped.');
  ...
  console.log('[skip-mode]   zh-hardcoded-english-guard');
}
