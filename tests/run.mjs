...
//
// --test-concurrency=1 is mandatory: 22 test files (baselayout-clerk-script,
...
// json-ld-faqpage-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 22
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 22 build-dependent suites skipped.');
  ...
  console.log('[skip-mode]   json-ld-field-guard, json-ld-faqpage-guard');
}
