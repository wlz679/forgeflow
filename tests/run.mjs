...
//
// --test-concurrency=1 is mandatory: 17 test files (baselayout-clerk-script,
...
// sitemap-url-coverage-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 17
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 17 build-dependent suites skipped.');
