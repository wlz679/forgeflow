...
//
// --test-concurrency=1 is mandatory: 23 test files (baselayout-clerk-script,
...
// json-ld-faqpage-guard, a11y-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 23
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 23 build-dependent suites skipped.');
