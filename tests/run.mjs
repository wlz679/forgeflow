...
//
// --test-concurrency=1 is mandatory: 8 test files (baselayout-clerk-script,
...
// tool-zh-cjk-preservation) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 8
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 8 build-dependent suites skipped.');
  ...
  console.log('[skip-mode]   tool-zh-cjk-preservation');
}
