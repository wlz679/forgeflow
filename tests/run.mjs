...
//
// --test-concurrency=1 is mandatory: 13 test files (baselayout-clerk-script,
...
// blog-cross-link-cjk-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 13
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 13 build-dependent suites skipped.');
