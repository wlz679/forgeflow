...
//
// --test-concurrency=1 is mandatory: 9 test files (baselayout-clerk-script,
...
// tool-zh-cjk-preservation, tool-en-cjk-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 9
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 9 build-dependent suites skipped.');
