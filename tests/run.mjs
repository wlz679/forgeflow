...
//
// --test-concurrency=1 is mandatory: 18 test files (baselayout-clerk-script,
...
// sitemap-url-coverage-guard, canonical-url-guard) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 18
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 18 build-dependent suites skipped.');
  ...
  console.log('[skip-mode]   canonical-url-guard');
}
