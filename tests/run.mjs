...
//
// --test-concurrency=1 is mandatory: 11 test files (baselayout-clerk-script,
...
// blog-zh-cjk-preservation) each spawn `pnpm build`
...
// P23b: skip-mode summary. When RUN_BUILD_TESTS is unset, the 11
...
if (!process.env.RUN_BUILD_TESTS) {
  console.log('\n[skip-mode] RUN_BUILD_TESTS not set — 11 build-dependent suites skipped.');
